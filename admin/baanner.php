...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
	...
	if($type=='delete'){
		mysqli_query($con,"delete from baanner where id='$id'");
	...
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update baanner set status='$status' where id='$id'");
		redirect('baanner.php');
	}

}

$sql="select * from baanner order by order_number";
...
?>
  <div class="card">
            <div class="card-body">
			  ...
			  <a href="manage_baanner.php" class="add_link">Add Banner</a>
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
						...
						<tr>
							...
							<td>
								<a href="manage_baanner.php?id=<?php echo $row['id']?>"><label class="badge badge-success hand_cursor">Edit</label></a>&nbsp;
								<?php
								if($row['status']==1){
								?>
